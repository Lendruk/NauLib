...
if(MSVC)
	target_link_options(cmrc-base INTERFACE /NODEFAULTLIB:libcmtd.lib )
	target_compile_options(cmrc-base INTERFACE /MTd)
	target_compile_options(cmrc-base INTERFACE /D_ITERATOR_DEBUG_LEVEL=0)
endif()
